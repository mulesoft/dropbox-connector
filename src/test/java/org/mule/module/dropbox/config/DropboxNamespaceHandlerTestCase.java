 ...
 */
package org.mule.module.dropbox.config;

import org.mule.construct.SimpleFlowConstruct;
import org.mule.tck.FunctionalTestCase;

public class DropboxNamespaceHandlerTestCase extends FunctionalTestCase
{
    @Override
    protected String getConfigResources()
    {
        return"dropbox-namespace-config.xml";
    }
    ...
    /*
        ...
        dropbox-namespace-config.xml and put the element from your
        cloud connector's namespace that you want to test into it.
        A proper example was put into dropbox-namespace-config.xml
